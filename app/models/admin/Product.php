...
class Product extends AppModel
{
    ...
    public function editRelatedProduct($id, $data)
    {
        ...
        if(empty($related_product) && !empty($data['related'])) {
            ...
            \R::exec("INSERT INTO related_product (product_id, related_id) VALUE $sql_part");
            return;
        }
    ...
    public function editFilter($id, $data)
    {
        ...
        //Если удалили фильтры, удаляем их
        ...
        if(empty($filter) && !empty($data['attrs'])){
            ...
            $sql_part = rtrim($sql_part, ',');
            \R::exec("INSERT INTO attribute_product (attr_id, product_id) VALUE $sql_part");
            return;
        }
    ...
    public function saveGallery($id)
    {
        if(!empty($_SESSION['multi'])) {
            ...
            $sql_part = rtrim($sql_part, ',');
            \R::exec("INSERT INTO gallery (img, product_id) VALUE $sql_part");
